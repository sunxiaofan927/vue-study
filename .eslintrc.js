...
module.exports = {
  ...
  rules: {
    ...
    "strict": 0, // 要求或禁止使用严格模式指令;["error","global"]、["error","function"]、["error","never"]
    
    // Variables => 这些规则与变量声明有关
    "init-declarations": [1, "always"], // 要求或禁止 var 声明中的初始化;["error", "never", { "ignoreForLoopInit": true }]
    "no-delete-var": 2, // 禁止删除变量
    "no-label-var": 1, // 不允许标签与变量同名
    "no-restricted-globals": 0, // 禁用特定的全局变量
    "no-shadow": [1, { "hoist": "functions" }], // 禁止变量声明与外层作用域的变量同名
    ...
    "object-curly-newline": [2, "always"], // 强制大括号内换行符的一致性
    ...
    "quotes": [2, "double", { "avoidEscape": true }], // 强制使用一致的反勾号、双引号或单引号
